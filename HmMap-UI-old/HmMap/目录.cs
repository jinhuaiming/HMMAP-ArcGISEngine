    ...
    public partial class 目录 : Form
    {
       ...
       public static double angle;
        ...
        private void 开始编辑ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                case esriGeometryType.esriGeometryPoint:
                    HmMap.index._tool_lable = PublicMark.ButtonFunction.DrawPoint;                   
                    break;
                case esriGeometryType.esriGeometryPolygon:
                    HmMap.index._tool_lable = PublicMark.ButtonFunction.DrawPolygon;
                    break;
                case esriGeometryType.esriGeometryPolyline:
                    HmMap.index._tool_lable = PublicMark.ButtonFunction.Drawpolyline;
                    break;        
            }
        }     
    }
